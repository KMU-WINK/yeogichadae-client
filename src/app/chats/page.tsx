                ...
                <div className="bg-secondary/10 flex-1 space-y-2 overflow-y-auto p-4">
                  ...
                  {messages.map((msg, index) => {
                    ...
                    return (
                      <div
                        key={msg.id}
                        className={`flex ${isMine ? 'justify-end' : 'justify-start'} ${showAvatarAndName && index !== 0 && 'mt-4'}`}
                      >
                        <div className={`flex max-w-[80%] ${isMine ? 'ml-auto justify-end' : ''}`}>
                          {!isMine ? (
                            <>
                              {/* 프로필 아바타 공간 고정 */}
                              <div className="mr-1.5 w-9 flex-shrink-0">
                                {showAvatarAndName ? (
